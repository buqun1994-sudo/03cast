...
internal class FixtureDeviceCommerceTransport(
    ...
    private fun createChallenge(request: DeviceCommerceHttpRequest): DeviceCommerceHttpResponse {
        ...
        return success(
            JSONObject()
                ...
                .put(
                    "product",
                    JSONObject().put("title", "03投屏Pro（永久）")
                )
    ...
    private fun refreshLicense(request: DeviceCommerceHttpRequest): DeviceCommerceHttpResponse {
        ...
        return when (entitlementScenario) {
            ...
            DebugEntitlementScenario.DEVICE_KEY_MISMATCH -> {
                failure(409, "device_key_mismatch")
            }
    ...
    private fun checkEntitlement(request: DeviceCommerceHttpRequest): DeviceCommerceHttpResponse {
        ...
        if (entitlementScenario == DebugEntitlementScenario.DEVICE_KEY_MISMATCH) {
            return failure(
                409,
                "device_key_mismatch",
                JSONObject()
                    .put("status", "device_key_mismatch")
    ...
    private fun PurchaseRecord.pendingJson(includeToken: Boolean, includeQr: Boolean): JSONObject {
        ...
        if (includeQr) {
            ...
            body.put("qrCodeValue", "https://fixture.03cast.invalid/$id")
        }
        return body
    }
