...
class CommercialLayoutContractTest {
    ...
    fun waitingStatesKeepPurchaseDetailBelowAdAndUseInlineProStatus() {
        ...
        val mainActivity = File(
            appDirectory,
            "src/main/java/com/tcrrry/desktopcast/MainActivity.kt",
        ).readText()
        val waiting = File(
            appDirectory,
            "src/main/res/layout/view_cast_commercial_waiting.xml",
        ...
        val renderer = File(
            appDirectory,
            "src/main/java/com/tcrrry/desktopcast/CastCommercialWaitingRenderer.kt",
        ).readText()
    ...
    fun runtimeBoundaryKeepsReceiverAliveWhenCommercialAccessIsDenied() {
        val router = File(
            findAppDirectory(),
            "src/main/java/com/tcrrry/desktopcast/service/CastPlaybackRouter.kt",
        ).readText()
        val service = File(
            findAppDirectory(),
            "src/main/java/com/tcrrry/desktopcast/service/CastService.kt",
        ).readText()
